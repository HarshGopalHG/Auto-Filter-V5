...
API_ID = int(environ.get('API_ID', '17274454'))
API_HASH = environ.get('API_HASH', '62ccfe695708861a0636bb431f536d17')
BOT_TOKEN = environ.get('BOT_TOKEN', "5803945415:AAFfV6KRoC9wQH_AVJDM98u3Wfk1xq2wuw8")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1040325642').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://<username>:<password>@originaldb.jrqk6ir.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Streamerview Database")
...
# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', -1001716468979))
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001756675023))
...
# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001755481812))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001755481812))
